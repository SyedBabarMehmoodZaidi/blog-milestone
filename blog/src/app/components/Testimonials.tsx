...
const Testimonials = () => {
  return (
    <div >
        <div className='container grid-cols-2 mt-8'>
        <h2 className='font-bold text-2xl flex flex-col items-center'>Testmonials</h2>
        ...
        <div className='bg-green-600 bg-[url(/cta-banner.avif)] bg-cover h-[400px] rounded-2xl grid place-items-center'>
    <div className='bg-[#ffffffab]  hover:bg-blue-300 min-w-[270px] sm:min-w-[300px] md:min-w-[500px] rounded-xl py-8 sm:px-8 px-2 grid place-items-center gap-3 border-4 border-white'>
        <button className='bg-blackish text-white p-2 rounded-md' data-aos="zoom-out-left" data-aos-duration="1000">RARE</button>        
