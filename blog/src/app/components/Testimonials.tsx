...
const Testimonials = () => {
  return (
    ...
    <div className='bg-[#ffffffab]  hover:bg-red-300 min-w-[270px] sm:min-w-[300px] md:min-w-[500px] rounded-xl py-8 sm:px-8 px-2 grid place-items-center gap-3 border-4 border-white'>
